...
package app.learning.fantaster.nhatkyhoctiengnhat.util.slidingtab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setDistributeEvenly(boolean mDistributeEvenly) {
        this.mDistributeEvenly = mDistributeEvenly;
        layoutParams = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT, 1f);
    }
