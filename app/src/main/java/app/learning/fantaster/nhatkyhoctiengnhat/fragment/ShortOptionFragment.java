...
/*    public TextView getTypeIndicator() { return typeIndicator; }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_for_short_option, container, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        exam = (JLPTExam) getContext();
        TextView typeIndicator = (TextView) view.findViewById(R.id.short_option_title);
        TextView questionView = (TextView) view.findViewById(R.id.question_in_short_fragment);

        option1 = (Button) view.findViewById(R.id.option1_in_short_fragment);
        option1.setOnClickListener(new OnChooseListener());

        option2 = (Button) view.findViewById(R.id.option2_in_short_fragment);
        option2.setOnClickListener(new OnChooseListener());

        option3 = (Button) view.findViewById(R.id.option3_in_short_fragment);
        option3.setOnClickListener(new OnChooseListener());

        option4 = (Button) view.findViewById(R.id.option4_in_short_fragment);
        ...
        if (currentChosenOptionId != 0) {
            ...
            if (currentChosenOptionId == R.id.option1_in_short_fragment)
                option1.setBackgroundColor(Color.YELLOW);
            if (currentChosenOptionId == R.id.option2_in_short_fragment)
                option2.setBackgroundColor(Color.YELLOW);
            if (currentChosenOptionId == R.id.option3_in_short_fragment)
                option3.setBackgroundColor(Color.YELLOW);
            if (currentChosenOptionId == R.id.option4_in_short_fragment)
