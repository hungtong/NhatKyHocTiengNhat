...
public class OptionInPortraitFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_for_option_portrait, container, false);
    }

    @Override
    public void onViewCreated(View portraitView, Bundle savedInstanceState) {
        exam = (JLPTExam) getActivity();

        TextView typeIndicator = (TextView) portraitView.findViewById(R.id.option_title_portrait);
        TextView questionView = (TextView) portraitView.findViewById(R.id.question_in_fragment_portrait);

        int currentQuestion = JLPTExam.currentNumberOfQuestions;
        questionView.setText(exam.getQuestionAt(currentQuestion));

        option1 = (Button) portraitView.findViewById(R.id.option1_in_fragment_portrait);
        option2 = (Button) portraitView.findViewById(R.id.option2_in_fragment_portrait);
        option3 = (Button) portraitView.findViewById(R.id.option3_in_fragment_portrait);
        option4 = (Button) portraitView.findViewById(R.id.option4_in_fragment_portrait);
    ...
    class OnChooseListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            switch (clickedId) {
                case R.id.option1_in_fragment_portrait :
                    if (chosenOptionId == 0)
                        option1.setBackgroundColor(Color.YELLOW);
                    else {
                        option1.setBackgroundColor(Color.YELLOW);
                ...
                case R.id.option2_in_fragment_portrait :
                    if (chosenOptionId == 0)
                        option2.setBackgroundColor(Color.YELLOW);
                    else {
                        option2.setBackgroundColor(Color.YELLOW);
                ...
                case R.id.option3_in_fragment_portrait :
                ...
                case R.id.option4_in_fragment_portrait :
