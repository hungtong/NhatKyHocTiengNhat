...
public class VocabGrammarFragment extends Fragment {

    private Exam exam;
    private TextView typeIndicator, questionView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_vocab_grammar_questions, container, false);
    }

    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        exam = (Exam) getContext();
        typeIndicator = (TextView) view.findViewById(R.id.vocab_grammar_title);
        questionView = (TextView) view.findViewById(R.id.vocab_grammar_question);

        option1 = (Button) view.findViewById(R.id.option1_in_vocab_grammar_question);
        option1.setOnClickListener(new OnChooseListener());

        option2 = (Button) view.findViewById(R.id.option2_in_vocab_grammar_question);
        option2.setOnClickListener(new OnChooseListener());

        option3 = (Button) view.findViewById(R.id.option3_in_vocab_grammar_question);
        option3.setOnClickListener(new OnChooseListener());

        option4 = (Button) view.findViewById(R.id.option4_in_vocab_grammar_question);
    ...
    class OnChooseListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            switch (clickedId) {
                case R.id.option1_in_vocab_grammar_question :
                    if (chosenOptionId == 0)
                    ...
                    break;
                case R.id.option2_in_vocab_grammar_question :
                    if (chosenOptionId == 0)
                    ...
                    break;
                case R.id.option3_in_vocab_grammar_question :
                    if (chosenOptionId == 0)
                    ...
                    break;
                case R.id.option4_in_vocab_grammar_question :
                    if (chosenOptionId == 0)
